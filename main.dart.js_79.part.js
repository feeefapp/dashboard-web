...
C=c[77]
B.cHG.prototype={
wd(d){return this.bMX(d)},
bMX(d){var x=0,w=A.q(y.b),v,u=this,t
var $async$wd=A.m(function(e,f){if(e===1)return A.n(f,w)
for(;;)switch(x){case 0:t=d.r==null&&d.a==null
if(t)throw A.x(A.ch("At least one of uri, files or text must be provided",null))
t=d.a
if(t!=null&&t.length===0)throw A.x(A.ch("text provided, but cannot be empty",null))
v=u.a.wd(d)
x=1
break
case 1:return A.o(v,w)}})
return A.p($async$wd,w)}}
B.cHE.prototype={}
