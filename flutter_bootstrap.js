...
_flutter.buildConfig = {"engineRevision":"b267090e310ab697b55c84373da954674f653b37","builds":[{"compileTarget":"dart2js","renderer":"canvaskit","mainJsPath":"main.dart.js"},{}]};
...
_flutter.buildConfig.builds.forEach(build => {
    build.mainJsPath += "?v="+"2175282650" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */;
});
    
_flutter.loader.load({
  config: {
    ...userConfig,
    mainJsPath: "main.dart.js?v=" + "2175282650" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */,
  },
  serviceWorkerSettings: {
    serviceWorkerVersion: "2175282650" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */,
  },
