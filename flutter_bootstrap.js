...
_flutter.buildConfig.builds.forEach(build => {
    build.mainJsPath += "?v="+"2832604923" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */;
});
    
_flutter.loader.load({
  config: {
    ...userConfig,
    mainJsPath: "main.dart.js?v=" + "2832604923" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */,
  },
  serviceWorkerSettings: {
    serviceWorkerVersion: "2832604923" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */,
  },
